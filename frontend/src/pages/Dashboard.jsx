      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Quick FAQ */}
            <div className="bg-gradient-to-b from-blue-50 to-indigo-50 rounded-3xl p-6 shadow-xl border border-blue-100">
              ...
              <div className="space-y-2">
                {faqs.slice(0, 3).map((faq, index) => (
                  <div key={index} className="bg-white rounded-xl overflow-hidden">
                    <button
                      ...
                      className="w-full p-3 text-left flex items-center justify-between hover:bg-blue-50 transition-colors"
                    >
                      <span className="text-sm font-medium text-gray-800">{faq.question}</span>
                      <ChevronDown className={`w-4 h-4 text-blue-500 transition-transform ${openFaqIndex === index ? "rotate-180" : ""}`} />
                    </button>
                    {openFaqIndex === index && (
                ...
                <Link to="/faq" className="block w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-2 px-4 rounded-xl text-center text-sm font-semibold hover:shadow-lg transition-all duration-300 mt-3">
                  View All FAQs
                </Link>
              </div>
            </div>
